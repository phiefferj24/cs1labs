...
public class Robot
{
    ...
    private static Image ROBOT_NORTH_IMAGE = loadImage("robotnorth.gif");
    private static Image ROBOT_SOUTH_IMAGE = loadImage("robotsouth.gif");
    private static Image ROBOT_EAST_IMAGE = loadImage("roboteast.gif");
    private static Image ROBOT_WEST_IMAGE = loadImage("robotwest.gif");
    private static Image WALL_IMAGE = loadImage("wall.gif");
    private static Color LIGHT_COLOR = new Color(230, 170, 120);
    private static Image DARK_COLOR = loadImage("darkcolor.png");
            ...
            for (int row = 0; row < grid.length; row++)
            {
                for (int col = 0; col < grid[0].length; col++)
                {
                    ...
                    else if (grid[row][col] == CELL_DARK)
                    {
                        ...
                        //g.fillRect(x, y, cellSize, cellSize);
                    	 g.drawImage(DARK_COLOR, x, y, cellSize, cellSize, null);
                    }
